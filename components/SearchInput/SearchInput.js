...
export default class SearchInput extends Component {
  ...
  static propTypes = {
    ...
    disabled: PropTypes.bool, inputContainer: ViewPropTypes.style, placeholderContainer: ViewPropTypes.style
  }
  ...
  render () {
    let { style, children, inputStyle, iconSize, disabled, value, placeholder, placeholderTextColor, selectionColor, pointerEvents, onBlur, onFocus, onChangeText, inputContainer = {},placeholderContainer, ...others } = this.props
      ...
      <View style={style} pointerEvents={pointerEvents}>
        <View style={[styles.container, inputContainer]} onLayout={e => this.onContainerLayout(e)}>
          <View style={this.state.editing || value ? { width: this.state.width } : null}>
            <View style={[styles.placeholderContainer,placeholderContainer]} onLayout={e => this.onPlaceholderLayout(e)}>
